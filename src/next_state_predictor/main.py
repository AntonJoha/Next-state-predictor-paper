...
def _save_results(results, args):
    ...
    model_path = os.path.join(output_dir, f"model_{args.next_state_predictor}_{unique_id}.pt" )
    json_path = os.path.join(output_dir, f"json_{args.next_state_predictor}_{unique_id}.json" )
